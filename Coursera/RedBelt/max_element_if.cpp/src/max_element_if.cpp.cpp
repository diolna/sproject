...
//bool operator<(const std::_List_const_iterator<int> first,
//		const std::_List_const_iterator<int> last){
//	return *first < *last;
//}
...
void TestNoMax() {
  ...
  auto AlwaysTrue = [](int) {    // определение лямбда функции которая возвращает всегда true;
    return true;
  };
  Assert(
